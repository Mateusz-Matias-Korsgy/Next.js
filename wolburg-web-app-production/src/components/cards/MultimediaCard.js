...
const MultimediaCard = ({ image, title, subTitle }) => {
  return (
    <div className="grid grid-cols-1 gap-0 lg:grid-cols-2 text-center p-4 md:p-8 m-6 mb-12">
      <div className="md:py-16 order-2 md:order-1 ">
      ...
      <div className="items-center justify-center p-8 md:p-12 order-1 md:order2">
        <img
          src={image}
