  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      ...
      <header className="flex justify-end w-full p-4 space-x-4 text-sm text-gray-700">
        <a href="#" className="text-gray-450 font-bold hover:underline">Gmail</a>
        <a href="#" className="text-gray-450 font-bold hover:underline">Images</a>
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-4 text-center">
        ...
        <div className="flex flex-row sm:flex-row items-center w-full max-w-md p-2 border rounded-full shadow-sm hover:shadow-md focus-within:shadow-md">
          ...
          <div className="flex space-x-2 mt-2 sm:mt-0">
            <img src="/mic.png" className="w-6 h-auto mt-1 ml-1"/>
            <img src="/cam.png" className="w-6 h-auto mt-1 ml-1"/>
          </div>
        </div>

        <div className="flex flex-row sm:flex-row mt-8 space-x-4">
      ...
      <footer className="w-full py-4 text-sm text-gray-500 border-t">
        <div className="flex flex-col sm:flex-row justify-between max-w-screen-xl mx-auto px-4 space-y-2 sm:space-y-0">
          <div className="flex flex-row sm:flex-row space-x-8">
